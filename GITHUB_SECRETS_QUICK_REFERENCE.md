...
# Set staging secrets
gh secret set AZURE_CREDENTIALS_STAGING --env staging --body "$AZURE_CREDS_STAGING"
gh secret set RESOURCE_GROUP_STAGING --env staging --body "rg-westeurope-magictoolbox-staging-01"
gh secret set CONTAINER_APP_NAME_STAGING --env staging --body "$CONTAINER_APP_STAGING"
```
