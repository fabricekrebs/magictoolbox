  ...
  properties: {
    ...
    siteConfig: {
      appSettings: [
        ...
        // Note: FUNCTIONS_WORKER_RUNTIME is configured in functionAppConfig.runtime (not app settings) for Flex Consumption
        {
        ...
        // Application Insights integration (connection string is all that's needed for Python)
        {
